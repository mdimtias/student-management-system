...
const Navbar = () => {
    ...
    return (
        <div className='w-full'>
            ...
            <div className=" border-b md:px-4 py-2">
                ...
                <div className="flex items-center justify-between w-full ">
                    ...
                    <ul className={`md:flex  md:mr-10 w-full items-center absolute md:static duration-200 ease-in pb-5 md:pb-0 text-center bg-white justify-end gap-x-6  ${open ? 'top-[-100px]' : 'top-16 '}`}>
                        <li className=''>
                            <Link to='/' className="cursor-pointer text-sm font-medium  text-gray-900 hover:text-gray-900/70">Home</Link>
                        </li>
                        <li>
                            <Link to='products' className="cursor-pointer text-sm font-medium text-gray-900 hover:text-gray-900/70">Calender</Link>
                        </li>
                        <li>
                            <Link to='service' className="cursor-pointer text-sm font-medium text-gray-900 hover:text-gray-900/70">Resources</Link>
                        </li>
                        <li>
                    ...
                    <div className="flex ">
                        <form className="relative flex items-center rounded-full bg-white">
                            <label className="w-full">
                                <input className=" w-full rounded-full border-2 border-gray-900 px-4 py-2 pr-10 text-sm font-medium text-gray-900 outline-0 ring-gray-400 focus:ring-2" type="text" placeholder="search" />
                            </label>
                    ...
                    <div className='items-center flex-shrink-0 hidden  md:flex mx-5'>
                        <Link to='/login'><button className="py-1 px-5 text-black hover:bg-blue-200 bg-blue-300 rounded-2xl border-2 font-semibold ease-in-out duration-300">Sign in</button></Link>
                        <Link to='/register'><button className="py-1 px-5 text-black hover:bg-blue-200 bg-blue-300 rounded-2xl border-2 font-semibold ease-in-out duration-300">Join Now</button></Link>
                    </div>
